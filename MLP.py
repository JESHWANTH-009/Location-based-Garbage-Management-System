# -*- coding: utf-8 -*-
"""
Created on Sat Mar 13 18:17:27 2021

@author: OKOK PROJECTS
"""

#import librarries required for MLP modeling
import pandas as pd
import numpy as np
import keras
...
filename = r'C:/Major_project/Location Based Garbage Management/bin.csv' #load CSV file
...
model.add(Dense(1))
model.compile(loss='mean_squared_error', optimizer='adam') #model compilation
num_epochs = 500
...
prediction = model.predict(test_generator)  #forecast/predict for test data
...
group = 15
prediction = prediction.reshape(-1, group).mean(axis =1)
